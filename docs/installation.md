...
- Check the Kodi log for `[EUCert.service]` and `[EUCert.backfill]` entries to confirm it is running
- Enable debug logging in the addon's settings for detailed output in `eucert.log`
